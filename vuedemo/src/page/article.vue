	...
	export default {
		data: function () {
			return {
				content: null,
				resData: {},
				baseUrl: 'https://ouzhx.oss-cn-hangzhou.aliyuncs.com/filebase',
		...
		created: function () {
			...
			let url = 'https://ouzhx.oss-cn-hangzhou.aliyuncs.com/photosharing/sharedapi/viewShared'
		...
		methods: {
			...
			zan: function (id) {
				let url = 'https://ouzhx.oss-cn-hangzhou.aliyuncs.com/photosharing/thumbsupapi/thumbsUp'
			...
			star: function (sid, mid) {
				let url = 'https://ouzhx.oss-cn-hangzhou.aliyuncs.com/photosharing/favoritesapi/collect'
				let choice, num = event.target.parentNode;
