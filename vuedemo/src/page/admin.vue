...
<script>
  ...
  export default{
    data: function () {
      return {
        doList:'',
        baseUrl: 'https://ouzhx.oss-cn-hangzhou.aliyuncs.com'
      }
    },
    created: function () {
    ...
    methods:{
      fetchData:function () {
        let vm = this
        let url = 'https://ouzhx.oss-cn-hangzhou.aliyuncs.com'
      ...
      permit:function (id) {
        let url = 'https://ouzhx.oss-cn-hangzhou.aliyuncs.com/photosharing/administratirapi/authorityMember'
        axios.get(url,{
          params: {
            memberId: id,
            choice: 1　
